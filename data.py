...
# The current loader is not using the normalized edge maps for training and test. If you use the normalized edge maps
...
def get_loader(image_root, gt_root, edge_root, batchsize, trainsize, shuffle=True, num_workers=4, pin_memory=True):
    dataset = CODDataset(image_root, gt_root, edge_root, trainsize)
